    ...
    return (
        ...
        <div style={style} className=' mx-auto font-source-sans3 flex pt-[22rem]'>
            ...
            <div className='text-center mx-auto'>
                ...
                <Button data-hover="false" className='translate-y-1 hover:translate-y-0 rounded-md mt-8 h-16 w-72 bg-violet-600 tracking-wider text-xl font-bold text-white'>PROJECTS</Button>
