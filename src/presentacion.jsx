...
function Presentacion(){
    ...
    return (
        <>
        <div style={style} className=' font-source-sans3 flex pt-60'>
            ...
            <div className='text-center mx-auto'>
                ...
                <Button className=' rounded-md mt-8 h-16 w-72 bg-indigo-600 tracking-wider text-xl font-bold text-white'>PROJECTS</Button>

                <div className='mt-60 w-[25px] h-[40px] border-2 border-black rounded-t-[60px] rounded-b-[60px] mx-auto mb-8'>
                    <div className=' mx-auto w-[5px] h-[5px] rounded-full border-2 border-black mt-1 animate-raton fade-out-100'></div>
                </div>
            </div>
