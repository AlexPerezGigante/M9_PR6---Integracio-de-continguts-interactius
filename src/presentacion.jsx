...
function Presentacion(){
    ...
    return (
        <>
        <div style={style} className=' mx-auto font-source-sans3 flex pt-60'>
            ...
            <div className='text-center mx-auto'>
                ...
                <Button className=' rounded-md mt-8 h-16 w-72 bg-violet-600 tracking-wider text-xl font-bold text-white'>PROJECTS</Button>

                <div className='mt-72 w-[25px] h-[40px] border-2 border-black rounded-t-[60px] rounded-b-[60px] mx-auto mb-8'>
